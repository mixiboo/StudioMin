...
async function execute(interaction) {
    ...
    switch (subcommand) {
        case '채널': {
            ...
            (0, configManager_1.setLogChannel)(interaction.guildId, channel.id);
            return interaction.reply({
        ...
        case '켜기': {
            ...
            (0, configManager_1.setEventToggle)(interaction.guildId, eventName, true);
        ...
        case '끄기': {
            const eventName = interaction.options.getString('이벤트', true);
            (0, configManager_1.setEventToggle)(interaction.guildId, eventName, false);
            const eventLabel = EVENT_CHOICES.find(c => c.value === eventName)?.name || eventName;
            return interaction.reply({
        ...
        case '확인': {
            const config = (0, configManager_1.getGuildConfig)(interaction.guildId);
            if (!config) {
                return interaction.reply({
